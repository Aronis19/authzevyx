...
function field(name, label, type, placeholder, autocomplete) {
  ...
  function profile(user) {
    const rows = [
      ...
      ["Premium (Auto login)", user.premium ? `Zapnuto <span style="margin-left:6px;font-size:14px;font-weight:400;opacity:.8;color:#94a3b8;font-family:ui-monospace,SFMono-Regular,Menlo,monospace">(${esc(user.uuid)})</span>` : "Vypnuto"]
    ];
